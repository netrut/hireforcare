...
exit();
  ...
  $insert_query = "INSERT INTO cust_tab(first_name, last_name,email,mobile,type,location,duration,age,monthly_pay,message,created_by,tnc ) Values('$first_name','$last_name' ,'$email','$number' ,'$type','$location','$duration','$age','$month_pay','$message','$created_by','$tnc')";
...
$id =implode ("",mysqli_fetch_assoc($result));
   ...
   try {
       ...
       $param_password = password_hash($password, PASSWORD_DEFAULT); // Creates a password hash
        ...
        $insert_user = "INSERT INTO user(user_id,username,last_name,email,phone,password,role_id) SELECT cust_id,first_name,last_name,email,mobile,'$param_password',3 FROM cust_tab where id='$id'";
...
<?php } ?>
            ...
            <div class="form-group">
							<input name="password" class="form-control" type="password" size="40" placeholder="Password* " required> 
						</div>
...
<?php } else { }?>
                    ...
                    <input name="tnc" class="form-check-input" type="checkbox" value="agree" id="invalidCheck" <?php if($_SESSION['role_id']==1 || $_SESSION['role_id']==2){echo "";}else{ echo "required";} ?>> Agree to <a href="">terms & conditions</a> and <a href="">Privacy-policy</a>
                    </label>
